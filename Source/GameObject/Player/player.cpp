...
void Player::Init()
{
	...
	m_stateIdle = new PlayerState_Idle;
	m_stateRun = new PlayerState_Run;
	m_stateJump = new PlayerState_Jump;
...
void Player::Update()
{
	...
	if (m_position.y <= groundHeight)
	{
		...
		if (typeid(*m_state) == typeid(PlayerState_Jump)) {
			m_state = m_stateIdle;
			m_AnimationName = "Idle";
		}
	}
